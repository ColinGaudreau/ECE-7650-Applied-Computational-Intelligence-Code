function varargout = logistic_regression(theta0, xdata, ydata, method, learning_rate)
...
for i=1:MAX_ITERATION
    ...
    elseif strcmpi(method,'grad')
        new_theta = theta - learning_rate * del_J(theta, xdata, ydata);
    else
